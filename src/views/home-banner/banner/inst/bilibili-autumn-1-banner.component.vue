...
const baseSrc = "/bilibili/autumn-1/";
const moveRate = -2;
...
function getLightImgList(
  type: "image" | "video"
): Array<{ type: "image" | "video"; file: string }> {
  return [
    {
      type: type,
      file: `62a1c4b6-da1f-437a-90f4-1427f058d2e9.${getFileType(type)}`,
    },
    { type: "image", file: "839af78322450ea0eb6dbb1d19889d831862804f.png" },
  ];
}

function getDarkImgList(
  type: "image" | "video"
): Array<{ type: "image" | "video"; file: string }> {
  return [
    {
      type: type,
      file: `8bcf476e-6c97-472b-b1e8-d19dd7170edf.${getFileType(type)}`,
    },
